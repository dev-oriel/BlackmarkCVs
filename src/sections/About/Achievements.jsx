const Achievements = () => {
  const stats = [
    { label: "CVs Created", value: "2000+" },
    { label: "Happy Clients", value: "500+" },
    { label: "Years of Experience", value: "5+" },
  ];

  return (
    <section className="relative text-center bg-gradient-to-r from-coral-400 via-coral-300 to-coral-500 text-white p-6 sm:p-8 lg:p-12 rounded-lg mb-12">
      {/* Decorative Elements */}
